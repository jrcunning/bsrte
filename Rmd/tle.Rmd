...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, cache = TRUE, fig.width = 10)
library(tidyverse)
library(lme4)
library(lsmeans)
```
...
posthocs <- left_join(posthocs, select(md, coral_id = source_coral_id, home = source_location)) %>%
